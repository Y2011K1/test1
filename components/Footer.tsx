    ...
    <footer className="bg-black border-t border-white/5 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 bg-primary rounded-custom flex items-center justify-center shadow-neon-blue">
                <span className="text-white font-bold text-lg">E</span>
              </div>
              <span className="text-xl font-bold tracking-tight">EduNova</span>
            </div>
            <p className="text-gray-500 text-sm leading-relaxed mb-6">Redefining the digital learning experience for the creators of tomorrow.</p>
            <div className="flex gap-4">
              <a className="w-10 h-10 rounded-custom bg-white/5 flex items-center justify-center hover:text-primary hover:bg-white/10 transition-all" href="#">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              <li><a className="hover:text-primary transition-colors" href="#">Course Catalog</a></li>
              <li><a className="hover:text-primary transition-colors" href="#">Mentorship</a></li>
              <li><a className="hover:text-primary transition-colors" href="#">Learning Paths</a></li>
              <li><a className="hover:text-primary transition-colors" href="#">Degrees</a></li>
            </ul>
          </div>
          <div className="col-span-1">
        ...
        <div className="pt-8 border-t border-white/5 text-center text-xs text-gray-600">
          © {new Date().getFullYear()} EduNova LMS Platform. All rights reserved. Built for the future.
        </div>
      </div>
    </footer>
  );
