        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glassmorphism p-8 rounded-custom border-l-4 border-primary">
            ...
            <div className="flex items-center gap-4">
              <img alt="User 1" className="w-12 h-12 rounded-full border-2 border-primary" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC30jmklS_DSLOCHBCLAqyVABYqbYiTAs5VM60vEycMkuG_vVwr4PlFQaNy4964hIPrk4rAG9TpX7EKLdcPg54hGAzl0x0wvctlL1he2zNEu_Pbf35wau-atNknEYBk4gMIXtHEy5CcU6aQ6qn55f7L3OpXFJUeAlGp2azvis1qyEhakIR7EN1bFaxYoxBuhRSDV5UNAKdc8YCzpWd8u41WxTa7LF0A8gxO6jQjUi8gzRM9rHTsAG52joDMamQdX9CWyz_zJFKZf08m"/>
              <div>
          ...
          <div className="glassmorphism p-8 rounded-custom border-l-4 border-cyberPurple">
            ...
            <div className="flex items-center gap-4">
              <img alt="User 2" className="w-12 h-12 rounded-full border-2 border-cyberPurple" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC01nAio0RpgMscUQZ09P53AYAoIri7M2OrhyAB67okHVDpuNKXDLUIv6j7empf1c5YYJ0_Uua0geuu4wxjIVSnpSkxg4JCcyCc0BlhlmekZz9kTmyj2zE9bQC-jzo31RcdhmvIl0zl2rxvFJVc2d0mrRduFeOt-9MGNNILPSUDdbpJLEVYDPLttqzk3509ZPEvMsuRRVTnRB1MXZWHS6wn1Z6TzGmAfEd8HyxX34cQGRvBJneq5bIutWgjiw2-dFt471SCSM7CnZMw"/>
              <div>
